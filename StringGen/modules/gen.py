...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@hackersankalp20"))
        else:
            ...
            await client.join_chat("HackerSankalp2.0")
    except KeyError:
        pass
    try:
